...
def make_plots(r0_var_index):
    ...
    load_path = results_dir / f"grid_search_{r0_var_index}.csv"
...
if __name__ == "__main__":
    if "snakemake" in globals():
        make_plots(
            int(snakemake.wildcards["r0_var_index"]),  # noqa: F821
        )
    else:
        for _r0_var_index in range(2):
            make_plots(_r0_var_index)
        plt.show()
