"""Script to combine the panels of Supplementary Figure 3 and save in SVG format."""
...
save_path = (
    pathlib.Path(__file__).parents[2] / "figures/paper_supp_figures/supp_figure_3.svg"
)
